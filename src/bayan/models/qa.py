...
def best_span(
    ...
    *,
    ...
    """
    نختار أفضل answer span من start/end logits.

    - start_logits: درجات الأماكن المحتملة لبداية الإجابة
    - end_logits: درجات الأماكن المحتملة لنهاية الإجابة
    - offsets: مكان كل token داخل النص الأصلي
    - null_score: درجة احتمال أن السؤال ما له جواب
    """
